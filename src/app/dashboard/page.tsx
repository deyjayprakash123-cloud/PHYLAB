...
import { Search, Beaker, GraduationCap, Info, Home } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Link href="/" className="bg-primary p-1.5 rounded-lg hover:opacity-80 transition-opacity">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mb-10 relative">
          ...
          <Input
            ...
            className="pl-10 py-6 text-lg rounded-xl shadow-sm focus-visible:ring-primary bg-white dark:bg-slate-900"
            value={search}
